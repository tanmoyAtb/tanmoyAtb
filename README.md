...
drawn to the parts that are easy to get wrong — how performance holds up under real traffic, how a
system is measured once it leaves the lab, and how it is designed so that it can grow. Products I
have helped build have reached 400,000+ users across three continents.
...
and Server-Sent Events. Next.js, React and React Native on the front end. MongoDB, PostgreSQL and
Redis for data; AWS, GCP, Docker and Linux underneath.

**Blockchain** — Ethereum and EVM chains, IPFS and Filecoin, NFT distribution systems, dApp
architecture and frontend security models.
...
- **[Diva](https://diva.com.bd)** — sanitary pad vending machines for public spaces across
  Bangladesh, with cash, RFID and bKash payment paths.
...
- [Managing real-time communication from a Node.js server with Server-Sent Events](https://dev.to/headlesstech/managing-real-time-communication-from-nodejs-server-to-client-with-server-sent-events-mf)
- Deploying Node.js on AWS, in three parts — [Dockerize and deploy to EC2](https://dev.to/tanmoyatb/dockerize-deploy-your-nodejs-app-with-env-on-aws-ec2-part-13-1m9k) · [auto-scale and load balance](https://dev.to/tanmoyatb/auto-scale-and-load-balance-dockerized-app-on-aws-part-23-9lh) · [CI/CD with CodeBuild, CodeDeploy and CodePipeline](https://dev.to/tanmoyatb/cicd-for-your-dockerized-app-with-aws-codebuild-codedeploy-and-codepipeline-part-33-1gd9)
...
[LinkedIn](https://linkedin.com/in/tanmoyatb) · tanmoy3399@gmail.com
